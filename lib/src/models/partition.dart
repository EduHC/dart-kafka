...
class Partition {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'abortedTransactions': abortedTransactions?.map((x) => x.toMap()).toList(),
      'batch': batch?.toMap(),
  ...
  factory Partition.fromMap(Map<String, dynamic> map) {
    return Partition(
      id: map['id'] as int,
      fetchOffset: map['fetchOffset'] != null ? map['fetchOffset'] as int : null,
      logStartOffset: map['logStartOffset'] != null ? map['logStartOffset'] as int : null,
      maxBytes: map['maxBytes'] != null ? map['maxBytes'] as int : null,
      errorCode: map['errorCode'] != null ? map['errorCode'] as int : null,
      highWatermark: map['highWatermark'] != null ? map['highWatermark'] as int : null,
      lastStableOffset: map['lastStableOffset'] != null ? map['lastStableOffset'] as int : null,
      abortedTransactions: map['abortedTransactions'] != null ? List<AbortedTransaction>.from((map['abortedTransactions'] as List<dynamic>).map<AbortedTransaction?>((x) => AbortedTransaction.fromMap(x as Map<String,dynamic>),),) : null,
      batch: map['batch'] != null ? RecordBatch.fromMap(map['batch'] as Map<String,dynamic>) : null,
      errorMessage: map['errorMessage'] != null ? map['errorMessage'] as String : null,
      activeProducers: map['activeProducers'] != null ? List<ActiveProducer>.from((map['activeProducers'] as List<dynamic>).map<ActiveProducer?>((x) => ActiveProducer.fromMap(x as Map<String,dynamic>),),) : null,
      baseOffset: map['baseOffset'] != null ? map['baseOffset'] as int : null,
      logAppendTimeMs: map['logAppendTimeMs'] != null ? map['logAppendTimeMs'] as int : null,
      recordErrors: map['recordErrors'] != null ? List<RecordError>.from((map['recordErrors'] as List<dynamic>).map<RecordError?>((x) => RecordError.fromMap(x as Map<String,dynamic>),),) : null,
      throttleTimeMs: map['throttleTimeMs'] != null ? map['throttleTimeMs'] as int : null,
      timestamp: map['timestamp'] != null ? map['timestamp'] as int : null,
      offset: map['offset'] != null ? map['offset'] as int : null,
      leaderEpoch: map['leaderEpoch'] != null ? map['leaderEpoch'] as int : null,
    );
  }

  String toJson() => json.encode(toMap());

  factory Partition.fromJson(String source) => Partition.fromMap(json.decode(source) as Map<String, dynamic>);
}
