...
import 'component/offset_commit_topic.dart';
import 'component/request/offset_commit_partition_request.dart';
import 'component/response/offset_commit_partition_response.dart';
import 'component/response/offset_commit_topic_response.dart';
import 'offset_commit_response.dart';
...
class KafkaOffsetCommitApi {
  ...
  Uint8List serialize({
    ...
    for (final OffsetCommitTopic topic in topics) {
      ...
      for (final OffsetCommitPartitionRequest partition in topic.partitions) {
        buffer
  ...
  dynamic deserialize(Uint8List data, int apiVersion) {
    ...
    final List<OffsetCommitTopicResponse> topics = [];
